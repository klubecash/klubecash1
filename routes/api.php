...
return [
    ...
    $api('/api/mercadopago', 'api/mercadopago.php', 'api.mercadopago', ['GET', 'POST', 'OPTIONS']),
    ...
    $api('/api/openpix', 'api/openpix.php', 'api.openpix', ['POST', 'OPTIONS']),
    $api('/api/abacatepay', 'api/abacatepay.php', 'api.abacatepay', ['GET', 'POST', 'OPTIONS']),
    ...
    $api('/api/get-user-by-token', 'api/get-user-by-token.php', 'api.user-token', ['GET', 'POST'], ['api']),
    $api('/api/payments', 'api/payments.php', 'api.payments', ['POST', 'OPTIONS'], ['api', 'store']),
    $api('/api/store_details', 'api/store_details.php', 'api.store-details', ['GET'], ['api']),
    $api('/api/stores', 'api/stores.php', 'api.stores', ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'], ['api', 'admin']),
    $api('/api/stripe', 'api/stripe.php', 'api.stripe', ['GET', 'POST', 'OPTIONS']),
    $api('/api/stripe-webhook', 'api/stripe-webhook.php', 'api.stripe.webhook', ['POST']),
    $api('/api/validate-token', 'api/validate-token.php', 'api.validate-token', ['GET', 'POST']),
];
