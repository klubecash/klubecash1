...
$http = new FakeHttp();
$http->responses[]=['status'=>200,'body'=>'{"numberExists":true,"chatId":"5511999999999@lid"}'];
$http->responses[]=['status'=>200,'body'=>'{"id":"msg-1"}'];
$service=new WahaService($config,$http); $sent=$service->sendText('11999999999','Oi');
